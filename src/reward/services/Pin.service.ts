...
export class PinParams {
    constructor(public cRPId?: number, public startDate?: string, public endDate?: string, public projectId?: number, public currentPage?: number, public pageSize?: number) {
